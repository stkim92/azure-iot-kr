...
void atcm_reset_persistent_context(atcustom_persistent_context_t *p_persistent_ctxt)
{
  ...
  for (uint8_t i = 0U; i < MODEM_MAX_NB_PDP_CTXT; i++)
  {
    ...
    //p_tmp->conf_id = CS_PDN_NOT_DEFINED; /* not used */  //edited by tom 19.11.14
		p_tmp->conf_id = CS_PDN_USER_CONFIG_1; /* not used */
  ...
  p_predef = &p_persistent_ctxt->pdp_ctxt_infos[CS_PDN_USER_CONFIG_1];
  p_persistent_ctxt->pdn_default_conf_id = CS_PDN_USER_CONFIG_1;
  p_predef->conf_id = CS_PDN_USER_CONFIG_1;

	
#if defined(PDP_CONTEXT_DEFAULT_MODEM_CID)
  //reserve_user_modem_cid(p_persistent_ctxt, CS_PDN_PREDEF_CONFIG, PDP_CONTEXT_DEFAULT_MODEM_CID); //edited by tom 19.11.14
	reserve_user_modem_cid(p_persistent_ctxt, CS_PDN_USER_CONFIG_1, PDP_CONTEXT_DEFAULT_MODEM_CID);
