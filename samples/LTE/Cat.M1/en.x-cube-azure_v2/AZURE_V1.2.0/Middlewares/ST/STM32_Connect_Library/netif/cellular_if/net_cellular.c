...
void cellif_input(void const  *argument)
{
  ...
  for (;;)
  {
    ...
    if (levelMessage != dc_cellular_info.cs_signal_level_db)
    {
      ...
      {
				//strcpy( (char*)dc_cellular_info.mno_name, "hologram");
                                ...
                                bool use_internal_sim)
{
  ...
  if (use_internal_sim == true)
  {
    ...
    //memcpy(cellular_params.sim_slot[0].apn, "hologram", (size_t)sizeof("hologram"));
		memcpy(cellular_params.sim_slot[0].apn, "", (size_t)sizeof("")); //tom 19.11.19 for SK telecom
  ...
  else
  {
    ...
    //memcpy(cellular_params.sim_slot[1].apn, "hologram", (size_t)sizeof("hologram"));
  ...
  //cellular_params.set_pdn_mode = 1U; //edited by tom 19.11.14 pdn ipv4v6
	cellular_params.set_pdn_mode = 3U;
