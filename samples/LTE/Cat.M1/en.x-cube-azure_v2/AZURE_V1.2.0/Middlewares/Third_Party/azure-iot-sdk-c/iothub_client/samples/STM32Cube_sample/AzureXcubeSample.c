...
/* Private typedef -----------------------------------------------------------*/
extern void MX_ADC1_Init(void); // tom 19.11.29 define in main.c
 ...
 */
#define AZURE_USE_STM_DASHBOARD
// tom 19.11.25
...
//tom 19.11.29
/* Private sensor function prototypes -----------------------------------------------*/ 
...
float getTemperature_C(float _voltage)
{
    // LM35´Â ¼·¾¾ 1µµ´ç 10mVÀÇ ÀüÀ§Â÷¸¦ °®´Â´Ù.
    // ¼¾¼­ÇÉÀÇ Àü¾ÐÀÌ 0.28V¶ó¸é 280mVÀÌ¹Ç·Î ¿Âµµ´Â 28µµ¾¾.
    // 100À» °öÇØ¼­ ¼·¾¾ ¿Âµµ·Î ³ªÅ¸³¿
